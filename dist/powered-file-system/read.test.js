...
(0, node_test_1.describe)('read(src [, options])', { concurrency: false }, () => {
    ...
    (0, node_test_1.it)('Positive: Must read content of file; String type by default', async () => {
        const { length } = await index_1.pfs.read('./tmpdir/tings.txt');
    ...
    (0, node_test_1.it)('Positive: Must read Buffer content of file when encoding is null', async () => {
        const buffer = await index_1.pfs.read('./tmpdir/tings.txt', {
            encoding: null
        });
