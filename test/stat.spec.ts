...
describe(`stat(src [, options])`, () => {
  ...
  it(`Positive: Must return information a file in 'sync' mode`, async () => {
    const pfs = new PoweredFileSystem();
  ...
  it(`Positive: Must return information a directory in 'sync' mode`, async () => {
    const pfs = new PoweredFileSystem();
  ...
  it(`Positive: Must return information a symlink in 'sync' mode`, async () => {
    const pfs = new PoweredFileSystem();
